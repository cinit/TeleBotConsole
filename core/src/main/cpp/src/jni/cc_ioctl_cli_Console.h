...
#include <jni.h>
/* Header for class cc_ioctl_cli_Console */

#ifndef _Included_cc_ioctl_cli_Console
#define _Included_cc_ioctl_cli_Console
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 */
JNIEXPORT jobject JNICALL Java_cc_ioctl_cli_Console_nGetConsoleInfo
  (JNIEnv *, jobject);
